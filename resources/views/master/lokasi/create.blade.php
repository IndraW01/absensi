<x-app-layout title="Master - Tambah Lokasi">
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Lokasi Manual</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('master.lokasi.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('latitude_kantor') is-invalid @enderror"
                                id="latitude_kantor" name="latitude_kantor" value="{{ old('latitude_kantor') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('longitude_kantor') is-invalid @enderror"
                                id="longitude_kantor" name="longitude_kantor" value="{{ old('longitude_kantor') }}">
